...
---------DO NOT TOUCH (WILL BREAK THE SCRIPT)--------
config.societymoney = true		
config.society_name = 'society_mechanic' 
-----------------------------------------------------
...
config.logo = "https://media.discordapp.net/attachments/758890547468959785/810677039261941821/sergio_10.png" -- Add your own if you want

config.repair = true --Enables to repair vehicles through the menu